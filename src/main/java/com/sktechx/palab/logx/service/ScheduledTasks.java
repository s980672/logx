...
//        어제날짜
        ...
        System.out.println(">>"+date1+">>"+date2);
	         ...
	         try {
	            	...
	            	esService.generateSvcOption2PV(enumOptionType.ERROR_API,enumRCType.daily, date1, date2);
	            	esService.generateSvcOption2PV(enumOptionType.ERROR_APP,enumRCType.daily, date1, date2);
